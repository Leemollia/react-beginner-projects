...
export const User = ({ user, addToInviteList, selectedUsers }) => (
  <li>
    <div>
    ...
    <img onClick={() => addToInviteList(user.id)} className="action" src={`/assets/${selectedUsers.includes(user.id) ? 'minus' : 'plus'}.svg`} alt="Action" />
  </li>
);
